...
function renderKpis(){
 ...
 kpis.innerHTML=`<header><span class="eyebrow">NETWORK</span><span>${asOf}</span></header>
  ...
  <div class="oasis-kpi"><span>Controllers</span><strong>${fmt.format(k.controllers)}</strong><small>Added through the app since ${k.controllersSince}</small></div>
