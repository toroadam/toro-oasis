...
const speeds=[[3600,'1 hr/s'],[6*3600,'6 hr/s'],[12*3600,'12 hr/s'],[24*3600,'1 day/s']];let speedIndex=1;speed.textContent=speeds[speedIndex][1];layer.setSpeed(speeds[speedIndex][0]);
